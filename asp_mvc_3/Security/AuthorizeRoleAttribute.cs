...
namespace asp_mvc_3.Security
{
    public class AuthorizeRolesAttribute : AuthorizeAttribute
    {
        ...
        protected override void HandleUnauthorizedRequest(AuthorizationContext filterContext) { filterContext.Result = new RedirectResult("~/Home/UnAuthorized"); }
    }
}